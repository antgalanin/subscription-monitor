...
| **FULL MODE** | Автономная БД (курсовая ББД) | PostgreSQL (триггеры) | Таблицы + Ограничения целостности + Индексы + Витрины + Роли + Триггеры + RLS | Создаются через `test_data.sql` |
