-- =============================================================================
-- Создание таблиц (FULL MODE - нативные PostgreSQL ENUM типы)
-- =============================================================================
...
CREATE TYPE category_type AS ENUM ('SYSTEM', 'CUSTOM', 'LEGACY');
CREATE TYPE currency AS ENUM ('RUB', 'USD', 'EUR');
CREATE TYPE notification_type AS ENUM ('UPCOMING_PAYMENT', 'PAYMENT_SUCCESSFUL');

COMMENT ON TYPE user_role IS 'Роль пользователя в системе';
COMMENT ON TYPE category_type IS 'Тип категории подписки';
COMMENT ON TYPE currency IS 'Валюта платежа';
COMMENT ON TYPE notification_type IS 'Тип уведомления о платеже';
...
COMMENT ON COLUMN users.role IS 'Роль пользователя (тип user_role)';
...
COMMENT ON COLUMN categories.type IS 'Тип категории (тип category_type)';
...
COMMENT ON COLUMN payments.currency IS 'Валюта платежа (тип currency)';
...
COMMENT ON COLUMN notifications.notification_type IS 'Тип уведомления (тип notification_type)';
